    ...
    return Container(
      ...
      child: Column(
        children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      CircleAvatar(child: Image.asset("assets/images/png/mohamed_hassanien.png"),radius: 67.0,),
                      SizedBox(height: 15.0,),
                      Text("Mohamed Hassanien", style:  TextStyle(
                        fontFamily: 'Roboto',
                        color: Color(0xff000000),
                        fontSize: 20,
                        fontWeight: FontWeight.w500,
          ...
          MaterialButton(
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context){return EditAccountScreen();}));
              },
          ...
          MaterialButton(
            onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context){return ChangePasswordScreen();}));
            },
            shape: RoundedRectangleBorder(
                side: BorderSide(color: Colors.black12),
                borderRadius: BorderRadius.circular(5.0)
